...
public class Arac {
		...
		// 1) Arac isimli bir superclass (parent) olusturunuz, fields : renk ve motor(private), model(protected) olsun
		// 2) Constructor ekleyiniz, get ve set methodlari ve toString Method' unu ekleyiniz
		// 3) Bu siniftan (arac sinifi) Otobus sinifini uretiniz, otobusun ayrica yolcuSayisi field' inin ekleyiniz.

...
public class soru4 {
	...
	public static void main(String[] args) {
        ...
        String bolunmusKelimeArray2[]= str.split("a");// [J, v, , c, ndir.]
        ...
        String cumle="Java ogren, rahat yasa"; // cumle kac kelimeden olusur ? ODEV, TERSTEN YAZILACAK!!!
        
        String kelimeArrayi[]=cumle.split(" ");
        
        System.out.println("Cumledeki kelime sayisi : " + kelimeArrayi.length);//Cumledeki kelime sayisi : 4

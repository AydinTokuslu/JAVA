...
public class C01_StringBuilder {
    ...
    System.out.println("sb 'nin 5 dahil tum karakterleri :"+sb1.substring(5));//efehan guzel insan
    ...
    sb1.delete(3, 7);
    System.out.println("3-7 arası karakter silinmis hali : "+sb1);//farfehan guzel insan
    sb1.deleteCharAt(2);//sb1.delete(2,3);-->2. karakteri siler
    System.out.println("2. karakter silinmis hali : "+sb1);//fafehan guzel insan
    ...
    sb1.insert(2, "r");
    System.out.println("2. index'e r eklenmis hali : "+sb1);//farfehan guzel insan
    ...
    System.out.println("sb3 ilk hali : "+sb3);//Bugun hava cook iscakk
    sb3.reverse();
    System.out.println("sb3 ters cevirilmis hali : "+sb3);//kkacsi kooc avah nuguB
...
//SB toString methodu ile stringe cevirelerek string manipulation methodalri kullanilabilir .
    ...
    System.out.println(sb.append(s));//sb ye s nin 2 ile 5 arasini appent et ekle, //hayathayat

...
public class Exceptions06 {
	...
	public static void main(String[] args) {
		...
		String str1=" ";//space
        String str2="";//hiclik
        String str3=null;//str3 veriable'nin hic bir degere esit olamdigini belirten bir pointer(belirtec -isaretci)
                        //null bir dger degildir ama konsola yazdirilabilir

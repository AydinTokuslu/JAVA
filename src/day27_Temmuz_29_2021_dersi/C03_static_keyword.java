package day27_Temmuz_29_2021_dersi;
...
public static void main(String[] args) {
	...
	// Bir method veya variable' i static yapmanın avantajı;
	
	// Static variable ve method' lara ulasmak istedigimizde classIsmi.methodIsmi yazmamız
	...
	System.out.println(C01.sayi2); 			// 0 yazdirir
	
	// Java runtime bir programdir, hangi class' ta run tuşuna basarsaniz o class calisir!!!

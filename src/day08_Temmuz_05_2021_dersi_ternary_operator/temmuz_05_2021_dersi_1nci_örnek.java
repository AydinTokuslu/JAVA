...
public class temmuz_05_2021_dersi_1nci_örnek {
	...
	if (yil % 4 != 0) {
		System.out.println("girdiğiniz yıl artık değildir ");  // 4 ıle bölünemeyen
	} else if (yil % 100 != 0) {   // 4 ile bölünebilenler
		System.out.println(" girdiğiniz yıl artık yıldır");
	} else if (yil % 400 == 0) {   // 4 ve 100'e bölünebilenler
		System.out.println("girdiğiniz yıl artık yıldır");
	} else {

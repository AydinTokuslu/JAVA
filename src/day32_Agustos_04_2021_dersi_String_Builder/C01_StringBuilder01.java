...
public class C01_StringBuilder01 {
	...
	public static void main(String[] args) {
	    ...
	    //istenen index'e istenen karakteri ve karakterleri eklemek --> obj.insert(index,obj) : insert metodo parametre olarak sadece char almz obj alabilir
	    sb1.insert(2, "r");
	    System.out.println("2. index'e r eklenmis hali : "+sb1);//2. index'e r eklenmis hali : farfehan guzel insan

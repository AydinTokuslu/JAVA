...
public class ornek4_method_creation {
	...
	public static void main(String[] args) {
		 ...
		 * kucuk olacak sekilde, KK numarasini ise 4 rakamlik 4 blok 
		 * ve aralarinda bosluk olacak sekilde duzelten 2 method yazin, 
		 * ve programda kullanabilmek icin duzenlenmis 
		 * hallerini geri dondurun.	 */
